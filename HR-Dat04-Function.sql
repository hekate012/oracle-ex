...
TO_CHAR() 함수
    ...
    DD 숫자 형식의 월간 일
    AM OR PM 자오선 표시
    A.M. OR P.M. 마침표가 있는 자오선 표시
    HH OR HH12 OR HH24 하루 시간 OR 반일시간(1-12) OR 전일 시간(0-23)
    MI 분(0-59)
    SS 초(0-59)
...
/*
NULLIF()함수
    두 표현식을 비교하면 null 반환, 다르면 expr1을 반환합니다.
