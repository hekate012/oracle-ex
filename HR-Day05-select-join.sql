...
/*
USING 절로 조인 생성
    Natural join 은 이름과 데이터 유형이 대응되는 모든 열을 사용하여 테이블 조인합니다.
*/
...
*/
SELECT e.employee_id, e.lst_name, e.department_id,
...
/*
Cartesian Product
    조인 조건이 잘못되거나 완전히 생략 된 경우 결과는 모든 행 조합이 표시되는 Cartesisa Product로 나타납니다.
*/
/*
Cross Join 생성
