...
/*
비교 연산자
    특정 표현식을 다르값이나 표현식과 비교하는 조건에서 사용됩니다.
...
LIKE 연산자를 사용하여 패턴 일치
    LIKE 연산자를 사용하여 유효한 검색 문자열 값의 대체 문자검색을 수행합니다.
...
/*
논리 연산자를 사용하여 조건정의
    AND : 구성 요소 조건이 모두 참인 경어 TRUE 반환
    OR  : 구성 요소 조건이 하나가 참인 경우 TRUE 반환
